<%@ Page Title="" Language="C#" MasterPageFile="~/Master_page.Master" AutoEventWireup="true" CodeBehind="page_login_user.aspx.cs" Inherits="web_example.Web_Pages.WebForm1" %>
        ...
        <div id="lamisma">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    <asp:Button ID="btn_singup" style=margin-top:20px class="btn btn-primary" runat="server" Text="Sing Up" OnClick="btn_singup_Click" /></td>
                </div>
